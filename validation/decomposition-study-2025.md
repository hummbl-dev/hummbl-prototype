...
- Explicit separation of constraints from implementation
- Recognition of "rapid iteration" as architectural constraint
- Identification of validation as distinct from building
- Clear delineation between research and production phases
